...
Currently no helpers are defined for ENS. For proposals involving Safe transactions, Zodiac Roles, or MultiSend batching, add helpers to `src/ens/helpers/`. See `docs/proposal-review/reference.md` for helper documentation.
